                ...
                <form action="{{ route('view.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('inputnamabarang') is-invalid @enderror"
                            id="inputnamabarang" name="inputnamabarang" placeholder="Isikan nama barang!" value="{{ old("nama_barang") }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('inputhargabarang') is-invalid @enderror"
                            id="inputhargabarang" name="inputhargabarang" placeholder="Isikan harga barang!" value="{{ old("harga") }}">
                    ...
                    <div class="mb-3">
                        ...
                        id="inputstokbarang" name="inputstokbarang" placeholder="Isikan stok barang!" value="{{ old("stoked") }}">
